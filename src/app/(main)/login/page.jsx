...
export default function Page() {
    ...
    const [logigInfo, setLoginInfo] = useState();
        ...
        <div className={s.container}>
            ...
            <div className={s.ad}>
                <div className={s.content}>
                    ...
                    <div className={s.content_title}>
                        <h2>스마트한 인사관리의</h2>
                        <h3>새로운 기준</h3>
                        <span>직원 채용부터 급여, 근태까지 <br />하나의 플랫폼으로 관리하세요.</span>
                    </div>
            ...
            <div className={s.login}>
                ...
                <div className={s.input_box}>
                    ...
                    <input type="text" className={s.email} placeholder='이메일 주소를 입력하세요' onChange={(e) => setLoginInfo(prev => ({...prev, email: e.target.value}))} />
                    <label htmlFor="password">비밀번호</label>
                    <input type="password" className={s.password} placeholder='비밀번호를 입력하세요' onChange={(e) => setLoginInfo(prev => ({...prev, password: e.target.value}))} />
                    <input type="checkbox" className={s.check} /><span>로그인 상태 유지</span>
