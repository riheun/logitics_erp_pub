        ...
        <div className={s.container}>
            ...
            <div className={s.ad}>
                <div className={s.ad_content}>
                    ...
                    <h2>HRMaster와 함께</h2>
                    <h3>인사관리를 혁신하세요</h3>
                    <span>지금 가입하고 강력한 <br />인사관리 도구를 경험해보세요.</span>
                </div>
            ...
            <div className={s.join}>
                ...
                <div className={s.input_box}>
                    <div className={s.input1}>
                        ...
                        <input type="password" placeholder='비밀번호 입력' className={s.password} />
                    </div>
                    <div className={s.input2}>
                        ...
                        <input type="text" placeholder='company@example.com' className={s.email} />
                        <label htmlFor="passwordc">비밀번호 확인</label>
                        <input type="password" placeholder='비밀번호 재입력' className={s.passwordc} />
                    </div>
